# `experimental` — experimental features, research prototypes

> All merged PRs in [NVIDIA/Model-Optimizer](https://github.com/NVIDIA/Model-Optimizer) that touched **experimental** related code.
