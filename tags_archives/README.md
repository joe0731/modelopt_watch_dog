...
| Tag | Description | PRs |
|-----|-------------|:---:|
| [`core`](core/) | core utilities, tracing, optimization pipeline, common infrastructure | 75 |
| [`deploy`](deploy/) | modelopt.deploy - deployment tools, serving, vLLM, TensorRT-LLM integration | 20 |
...
| [`eval`](eval/) | model evaluation, benchmarking, accuracy metrics | 58 |
| [`example`](example/) | example scripts and notebooks | 163 |
| [`experimental`](experimental/) | experimental features, research prototypes | 6 |
| [`export`](export/) | model export, torch-to-ONNX conversion | 88 |
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 203 |
...
| [`quantization`](quantization/) | post-training quantization (PTQ), QAT, QAD, calibration, quantized layers | 174 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 171 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 259 |
