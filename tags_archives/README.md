...
| Tag | Description | PRs |
|-----|-------------|:---:|
| [`core`](core/) | core utilities, tracing, optimization pipeline, common infrastructure | 42 |
| [`deploy`](deploy/) | modelopt.deploy - deployment tools, serving, vLLM, TensorRT-LLM integration | 6 |
...
| [`eval`](eval/) | model evaluation, benchmarking, accuracy metrics | 30 |
| [`example`](example/) | example scripts and notebooks | 90 |
...
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 98 |
...
| [`quantization`](quantization/) | post-training quantization (PTQ), QAT, QAD, calibration, quantized layers | 103 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 97 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 153 |
