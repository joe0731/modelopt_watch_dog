...
| Tag | Description | PRs |
|-----|-------------|:---:|
| [`core`](core/) | core utilities, tracing, optimization pipeline, common infrastructure | 40 |
...
| [`example`](example/) | example scripts and notebooks | 87 |
...
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 94 |
...
| [`pruning`](pruning/) | model pruning, structured and unstructured | 9 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 93 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 147 |
