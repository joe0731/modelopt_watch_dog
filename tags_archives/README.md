...
| Tag | Description | PRs |
|-----|-------------|:---:|
| [`core`](core/) | core utilities, tracing, optimization pipeline, common infrastructure | 113 |
...
| [`eval`](eval/) | model evaluation, benchmarking, accuracy metrics | 88 |
| [`example`](example/) | example scripts and notebooks | 242 |
| [`experimental`](experimental/) | experimental features, research prototypes | 6 |
| [`export`](export/) | model export, torch-to-ONNX conversion | 117 |
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 367 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 264 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 369 |
