...
| [`docs`](docs/) | documentation, guides, API reference | 47 |
...
| [`export`](export/) | model export, torch-to-ONNX conversion | 153 |
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 540 |
...
| [`quantization`](quantization/) | post-training quantization (PTQ), QAT, QAD, calibration, quantized layers | 283 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 399 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 459 |
