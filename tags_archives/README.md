...
| Tag | Description | PRs |
|-----|-------------|:---:|
| [`core`](core/) | core utilities, tracing, optimization pipeline, common infrastructure | 153 |
...
| [`export`](export/) | model export, torch-to-ONNX conversion | 158 |
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 564 |
...
| [`quantization`](quantization/) | post-training quantization (PTQ), QAT, QAD, calibration, quantized layers | 288 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 415 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 466 |
