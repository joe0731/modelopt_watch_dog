...
| [`docs`](docs/) | documentation, guides, API reference | 46 |
| [`eval`](eval/) | model evaluation, benchmarking, accuracy metrics | 96 |
| [`example`](example/) | example scripts and notebooks | 288 |
| [`experimental`](experimental/) | experimental features, research prototypes | 6 |
| [`export`](export/) | model export, torch-to-ONNX conversion | 150 |
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 525 |
...
| [`quantization`](quantization/) | post-training quantization (PTQ), QAT, QAD, calibration, quantized layers | 281 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 387 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 455 |
