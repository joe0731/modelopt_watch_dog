...
| [`example`](example/) | example scripts and notebooks | 245 |
| [`experimental`](experimental/) | experimental features, research prototypes | 6 |
| [`export`](export/) | model export, torch-to-ONNX conversion | 121 |
...
| [`quantization`](quantization/) | post-training quantization (PTQ), QAT, QAD, calibration, quantized layers | 240 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 272 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 378 |
