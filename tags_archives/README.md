...
| [`eval`](eval/) | model evaluation, benchmarking, accuracy metrics | 89 |
| [`example`](example/) | example scripts and notebooks | 243 |
...
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 369 |
...
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 371 |
