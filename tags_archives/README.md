...
| Tag | Description | PRs |
|-----|-------------|:---:|
| [`core`](core/) | core utilities, tracing, optimization pipeline, common infrastructure | 108 |
...
| [`export`](export/) | model export, torch-to-ONNX conversion | 111 |
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 345 |
...
| [`quantization`](quantization/) | post-training quantization (PTQ), QAT, QAD, calibration, quantized layers | 231 |
...
| [`tests`](tests/) | test infrastructure, test utilities | 250 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 356 |
