...
| [`example`](example/) | example scripts and notebooks | 230 |
...
| [`infra`](infra/) | CI/CD, build system, GitHub/GitLab config, packaging | 328 |
...
| [`quantization`](quantization/) | post-training quantization (PTQ), QAT, QAD, calibration, quantized layers | 227 |
| [`sparsity`](sparsity/) | weight sparsity, attention sparsity | 25 |
| [`speculative_decoding`](speculative_decoding/) | speculative decoding, Eagle, Medusa, draft models | 65 |
| [`tests`](tests/) | test infrastructure, test utilities | 244 |
| [`torch`](torch/) | modelopt.torch - PyTorch optimization core library | 347 |
